...
# HORIZON = 720
# N_EPISODES = 200
# ALPHA_REG = 1.0         # Regularization for A_a = alpha_reg * I
# ALPHA_UCB = 2.0         # Exploration parameter in UCB
# WINDOW_SIZE = 2000
# MAX_DRIVERS = 10
#
#
...
#             scores[a] = mean + self.alpha_ucb * np.sqrt(max(0.0, var_term))
#         return scores
#
...
#             print(f"Episode {episode + 1}/{N_EPISODES}  Avg reward: {avg_rew:.6f}")
#
#     n = len(all_rewards)
...
#     plt.grid(True)
#     out_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "lin_ucb_reward10.png")
...
#     print("Starting LinUCB training (200 episodes, 720 steps each)")
